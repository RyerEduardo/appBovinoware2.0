...
public class CadastrarCompra extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cadastrar = (Button) findViewById(R.id.btnCadastrar1);
        fechar = (Button) findViewById(R.id.btnFechar1);
        ...
        switch (v.getId())
        {
            case R.id.btnCadastrar1:
                ...
                if(campoVasio == false) {
                    ...
                    resultado = con.createCompra(b);
                    Toast.makeText(this,resultado,Toast.LENGTH_LONG).show();
                    finish();
                }
                break;
            case R.id.btnFechar1:
                finish();
                break;
        }
    }
