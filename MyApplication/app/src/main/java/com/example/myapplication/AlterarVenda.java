...
public class AlterarVenda extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Venda bovino = con.exibirVenda(id);
        ...
        switch (view.getId()) {
            case R.id.btnAlterar:
                ...
                if (campoVasio == false) {
                    ...
                    resultado = con.updateVenda(b);
                    Toast.makeText(this, resultado, Toast.LENGTH_LONG).show();
                    lista = (ListView) findViewById(R.id.listaVendas);
                    finish();
                }
            ...
            case R.id.btnExcluir:
                ...
                msgBox.setPositiveButton(getString(R.string.op_sim_excluir), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int x) {
                        resultado = con.deleteVenda(id);
                        Toast.makeText(AlterarVenda.this, resultado, Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
